...
export const ARB = addressMapToTokenMap(
  {
    ...
    symbol: "ARB",
    name: "Arbitrum",
    icon: "https://toob.finance/media/arb.png",
  },
  ARB_ADDRESS
...
export const WBTC = addressMapToTokenMap(
  {
    ...
    symbol: "WBTC",
    name: "Wrapped BTC",
    icon: "https://toob.finance/media/wbtc.png",
  },
  WBTC_ADDRESS
...
export const WETH9 = addressMapToTokenMap(
  {
    ...
    symbol: "WETH",
    name: "Wrapped Ether",
    icon: "https://toob.finance/media/weth.png",
  },
  WETH9_ADDRESS
  ...
  ...(addressMapToTokenMap(
    {
      ...
      symbol: "USDC",
      name: "USD Coin",
      icon: "https://toob.finance/media/usdc.png",
    },
    USDC_ADDRESS
  ...
  ...(addressMapToTokenMap(
    {
      ...
      symbol: "USDT",
      name: "Tether USD",
      icon: "https://toob.finance/media/usdt.png",
    },
    USDT_ADDRESS
...
export const DAI = addressMapToTokenMap(
  {
    ...
    symbol: "DAI",
    name: "Dai Stablecoin",
    icon: "https://toob.finance/media/dai.png",
  },
  DAI_ADDRESS
...
export const TOOB = addressMapToTokenMap(
  {
    ...
    symbol: "TOOB",
    name: "Toob",
    icon: "https://toob.finance/media/toob.png",
  },
  TOOB_ADDRESS
