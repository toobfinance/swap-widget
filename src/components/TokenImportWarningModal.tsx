      ...
      >
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel className="w-full max-w-lg rounded-xl bg-[--color-primary-background] p-6 backdrop-blur-2xl px-10 py-8">
              <div className="flex justify-center">
                <Alert className="w-8 h-8" />
              </div>
              <h3 className="font-bold text-lg text-[--color-primary-text] text-center mt-2">
                Buy at your own risk!
              </h3>
              <p className="mt-2 text-sm text-[--color-primary-text] text-center">
              ...
              <div className="flex overflow-hidden cursor-pointer bg-[--color-link-background] py-1 px-2 rounded-lg text-[--color-active-text] mt-3">
                <a
              ...
              <button
                className="w-full bg-[--color-secondary-background] py-3 rounded-xl mt-4 hover:brightness-75 transition-all text-[--color-active-text]"
                onClick={() => {
                  onConfirm()
                  onClose()
                }}
